---
title: spotify_playlist_gen
description: Script that uses Spotipy API to create Spotify playlists with a balanced mix of popular and lesser-known tracks based on specific keywords.
date: "2024-04-16"
repository: AurelDeveloper/spotify_playlist_gen
published: true
---
