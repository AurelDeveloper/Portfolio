---
title: WebModeAnalyzer
description: WebModeAnalyzer is a Go-based project that analyzes a list of websites and determines whether they are in Dark Mode or Light Mode. The results are then stored in a JSON file.
date: "2024-03-24"
repository: AurelDeveloper/web-mode-analyzer
published: true
---
